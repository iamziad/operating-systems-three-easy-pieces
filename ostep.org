...
***** ليه الـheap و الـstack بيكبروا عكس بعض؟
...
- فكرته بتتمحور حوالين اننا عندنا 2 registers في الـCPU:
  ...
  - الـ *Bound register*: وده بيتخزن فيه حجم البرنامج الكلي في الذاكرة الحقيقية, عشان منعديهوش.

**** ألية الترجمة:

- اي عنوان وهمي البرنامج بيطلب انه يقرأ او يكتب عليه, المعالج بيترجمه فورا (on the fly) لعنوان حقيقي عن طريق المعادلة البسيطة دي: *Physical Address = Virtual Address + Base*

  ولو الـ *Physical address* اصغر من الـ *bound* يبقي تمام, لكن لو اكبر بيرمي *segmentation fault*.
